...
QString Level::toString() const
{
    ...
    case ALL_INT:
        return QCoreApplication::translate(p_context, "ALL");//ALL
    case TRACE_INT:
        return QCoreApplication::translate(p_context, "TRACE");//TRACE
    case DEBUG_INT:
        return QCoreApplication::translate(p_context, "DEBUG");//DEBUG
    case INFO_INT:
        return QCoreApplication::translate(p_context, "INFO");//INFO
    case WARN_INT:
        return QCoreApplication::translate(p_context, "WARN");//WARN
    case ERROR_INT:
        return QCoreApplication::translate(p_context, "ERROR");//ERROR
    case FATAL_INT:
        return QCoreApplication::translate(p_context, "FATAL");//FATAL
    case OFF_INT:
        return QCoreApplication::translate(p_context, "OFF");//OFF
    default:
